...
#    print(_ROOT)
    ...
    print("{} -t {} --rl ".format(fastANI,threads)+pwd+output+"/_MIST_cluster_sample_List --ql "+pwd+output+"/_MIST_cluster_sample_List -o " +pwd+output+"/_MIST_cluster_sample_Distance")
    os.system("{} -t {} --rl ".format(fastANI,threads)+pwd+output+"/_MIST_cluster_sample_List --ql " +pwd+output+"/_MIST_cluster_sample_List -o " +pwd+output+"/_MIST_cluster_sample_Distance")
    CRO={};point=[]
    #print(cutoff)
    cutoff=cutoff.split(",")
    for co in cutoff:
